...
require 'profile_me/search/magic_constants'
require 'profile_me/search/search_pagination_parser'
require 'profile_me/search/options/filter'

# these are the included filters. See Filter class documentation for adding your own.
require 'profile_me/search/options/age'
require 'profile_me/search/options/ethnicity'
require 'profile_me/search/options/order_by'
require 'profile_me/search/options/location'
require 'profile_me/search/options/paginator'
require 'profile_me/search/options/radius'
require 'profile_me/search/options/require_photo'
